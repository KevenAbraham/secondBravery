...
<body>
    <section class="sec stats" id="contact">
        <div class="content">
            <div class="mxw800p">
                <h4>Mudar senha</h4>
                <p class="p-stats">Preencha os campos abaixo</p>
            </div>  
            <div class="contactForm">
                <form name="formulario" method="POST">
                    <div class="row100">
                        ...
                        <div class="inputBox50">
                            <input type="text" name="senha" placeholder="Digite sua nova senha" autocomplete="off">
                        </div>
                    </div>
                    <div class="form">
                        <button name="button" onclick="document.formulario.action='../html/login.html'">Cancelar</button>
                        <button name="button" onclick="document.formulario.action='editar.php'">Alterar</button>
                    </div>
                </form>
            </div>
