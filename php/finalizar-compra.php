...
<body>
    ...
    <div class="checkout">
      ...
      <form class="form" name="formulario" autocomplete="off" novalidate>
        <fieldset>
        ...
        <button class="btn" onclick="document.formulario.action='final-compra.php'">submit</button>
      </form>
    </div>
    <!-- partial -->
      <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js'></script><script  src="../js/card.js"></script>
