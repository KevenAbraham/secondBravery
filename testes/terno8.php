<?php
    ...
    $zip = $_POST["zip"];
    $nCard = $_POST["nCard"];
    $prod = "Bravery RoyalOcean";
    $preco = "R$2.899,99";

    $sql = mysql_query("INSERT INTO tb_compra (nomeCliente, emailCliente, cpfCliente, endereco, estado, zip, numeroCartao, produto, preco) 
    VALUES ('$nome', '$email', '$cpf', '$endereco', '$estado', '$zip', '$nCard', '$prod', '$preco')");
?>
